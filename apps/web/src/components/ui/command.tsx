	...
	return (
		...
		>
			...
			<CommandPrimitive.Input
				...
				className={cn(
					"flex h-10 w-full rounded-md bg-transparent py-3 pl-2 text-sm outline-hidden placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50",
					className,
				)}
				{...props}
			/>
