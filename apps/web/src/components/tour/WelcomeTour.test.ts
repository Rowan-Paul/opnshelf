...
import { shouldRunTour, TOUR_STEPS, TOUR_VERSION } from "./WelcomeTour";
...
describe("shouldRunTour", () => {
	...
	it("stays out of the way of guests and of onboarding", () => {
		...
		expect(shouldRunTour({ ...base, pathname: "/embed/review-editor" })).toBe(
			false,
		);
	});
});
