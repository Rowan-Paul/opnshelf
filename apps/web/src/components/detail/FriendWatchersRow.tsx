...
export function FriendWatchersRow({
	...
	if (isLoading) {
		return (
			<div className="flex w-fit max-w-full animate-pulse items-center gap-2 overflow-hidden pl-1">
	...
	return (
		<div className="flex w-fit max-w-full items-center gap-2 overflow-hidden pl-1">
