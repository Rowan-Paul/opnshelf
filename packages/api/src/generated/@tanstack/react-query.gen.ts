 ...
 */
export const authControllerGooglePendingOptions = (options?: Options<AuthControllerGooglePendingData>) => queryOptions<unknown, DefaultError, unknown, ReturnType<typeof authControllerGooglePendingQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
