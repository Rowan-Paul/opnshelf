...
export const moviesControllerGetUserMovieWatchCountsQueryKey = (options: Options<MoviesControllerGetUserMovieWatchCountsData>) => createQueryKey('moviesControllerGetUserMovieWatchCounts', options);

/**
 * Get how many times a user watched each movie
 */
export const moviesControllerGetUserMovieWatchCountsOptions = (options: Options<MoviesControllerGetUserMovieWatchCountsData>) => queryOptions<MoviesControllerGetUserMovieWatchCountsResponse, DefaultError, MoviesControllerGetUserMovieWatchCountsResponse, ReturnType<typeof moviesControllerGetUserMovieWatchCountsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await moviesControllerGetUserMovieWatchCounts({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: moviesControllerGetUserMovieWatchCountsQueryKey(options)
});
 ...
 */
export const authControllerSuggestionsOptions = (options: Options<AuthControllerSuggestionsData>) => queryOptions<AuthControllerSuggestionsResponse, DefaultError, AuthControllerSuggestionsResponse, ReturnType<typeof authControllerSuggestionsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const authControllerGooglePendingQueryKey = (options?: Options<AuthControllerGooglePendingData>) => createQueryKey('authControllerGooglePending', options);

/**
 * Read the pending Google signup identity
 */
export const authControllerGooglePendingOptions = (options?: Options<AuthControllerGooglePendingData>) => queryOptions<AuthControllerGooglePendingResponse, DefaultError, AuthControllerGooglePendingResponse, ReturnType<typeof authControllerGooglePendingQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await authControllerGooglePending({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: authControllerGooglePendingQueryKey(options)
});
...
/**
 * Sign in with a native Google credential
 */
export const authControllerGoogleNativeMutation = (options?: Partial<Options<AuthControllerGoogleNativeData>>): UseMutationOptions<AuthControllerGoogleNativeResponse, DefaultError, Options<AuthControllerGoogleNativeData>> => {
    const mutationOptions: UseMutationOptions<AuthControllerGoogleNativeResponse, DefaultError, Options<AuthControllerGoogleNativeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await authControllerGoogleNative({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const authControllerAppleStartOptions = (options: Options<AuthControllerAppleStartData>) => queryOptions<unknown, DefaultError, unknown, ReturnType<typeof authControllerAppleStartQueryKey>>({
    ...
    queryKey: authControllerAppleStartQueryKey(options)
});

export const authControllerApplePendingQueryKey = (options?: Options<AuthControllerApplePendingData>) => createQueryKey('authControllerApplePending', options);

/**
 * Read the pending Apple signup identity
 */
export const authControllerApplePendingOptions = (options?: Options<AuthControllerApplePendingData>) => queryOptions<AuthControllerApplePendingResponse, DefaultError, AuthControllerApplePendingResponse, ReturnType<typeof authControllerApplePendingQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await authControllerApplePending({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: authControllerApplePendingQueryKey(options)
});

/**
 * Create an account from a verified Apple identity
 */
export const authControllerAppleRegisterMutation = (options?: Partial<Options<AuthControllerAppleRegisterData>>): UseMutationOptions<AuthControllerAppleRegisterResponse, DefaultError, Options<AuthControllerAppleRegisterData>> => {
    const mutationOptions: UseMutationOptions<AuthControllerAppleRegisterResponse, DefaultError, Options<AuthControllerAppleRegisterData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await authControllerAppleRegister({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Sign in with a native Apple credential
 */
export const authControllerAppleNativeMutation = (options?: Partial<Options<AuthControllerAppleNativeData>>): UseMutationOptions<AuthControllerAppleNativeResponse, DefaultError, Options<AuthControllerAppleNativeData>> => {
    const mutationOptions: UseMutationOptions<AuthControllerAppleNativeResponse, DefaultError, Options<AuthControllerAppleNativeData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await authControllerAppleNative({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
/**
 * Mint a verifier/challenge pair for the mobile OAuth handoff
 */
export const authControllerMobileChallengeMutation = (options?: Partial<Options<AuthControllerMobileChallengeData>>): UseMutationOptions<AuthControllerMobileChallengeResponse, DefaultError, Options<AuthControllerMobileChallengeData>> => {
    const mutationOptions: UseMutationOptions<AuthControllerMobileChallengeResponse, DefaultError, Options<AuthControllerMobileChallengeData>> = {
        mutationFn: async (fnOptions) => {
...
/**
 * Exchange a mobile OAuth handoff code for its session
 */
export const authControllerMobileExchangeMutation = (options?: Partial<Options<AuthControllerMobileExchangeData>>): UseMutationOptions<AuthControllerMobileExchangeResponse, DefaultError, Options<AuthControllerMobileExchangeData>> => {
    const mutationOptions: UseMutationOptions<AuthControllerMobileExchangeResponse, DefaultError, Options<AuthControllerMobileExchangeData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const usersControllerRetryMyTraktImportItemMutation = (options?: Partial<Options<UsersControllerRetryMyTraktImportItemData>>): UseMutationOptions<UsersControllerRetryMyTraktImportItemResponse, DefaultError, Options<UsersControllerRetryMyTraktImportItemData>> => {
    const mutationOptions: UseMutationOptions<UsersControllerRetryMyTraktImportItemResponse, DefaultError, Options<UsersControllerRetryMyTraktImportItemData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await usersControllerRetryMyTraktImportItem({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const listsControllerGetListMembershipsQueryKey = (options?: Options<ListsControllerGetListMembershipsData>) => createQueryKey('listsControllerGetListMemberships', options);

/**
 * Every item in the signed-in user's lists, with the lists that hold it
 */
export const listsControllerGetListMembershipsOptions = (options?: Options<ListsControllerGetListMembershipsData>) => queryOptions<ListsControllerGetListMembershipsResponse, DefaultError, ListsControllerGetListMembershipsResponse, ReturnType<typeof listsControllerGetListMembershipsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await listsControllerGetListMemberships({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: listsControllerGetListMembershipsQueryKey(options)
});
...
export const notificationsControllerCollectionQueryKey = (options: Options<NotificationsControllerCollectionData>) => createQueryKey('notificationsControllerCollection', options);

export const notificationsControllerCollectionOptions = (options: Options<NotificationsControllerCollectionData>) => queryOptions<NotificationsControllerCollectionResponse, DefaultError, NotificationsControllerCollectionResponse, ReturnType<typeof notificationsControllerCollectionQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await notificationsControllerCollection({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: notificationsControllerCollectionQueryKey(options)
});

export const notificationsControllerSettingsQueryKey = (options?: Options<NotificationsControllerSettingsData>) => createQueryKey('notificationsControllerSettings', options);

export const notificationsControllerSettingsOptions = (options?: Options<NotificationsControllerSettingsData>) => queryOptions<NotificationsControllerSettingsResponse, DefaultError, NotificationsControllerSettingsResponse, ReturnType<typeof notificationsControllerSettingsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await notificationsControllerSettings({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: notificationsControllerSettingsQueryKey(options)
});

export const notificationsControllerUpdateSettingsMutation = (options?: Partial<Options<NotificationsControllerUpdateSettingsData>>): UseMutationOptions<NotificationsControllerUpdateSettingsResponse, DefaultError, Options<NotificationsControllerUpdateSettingsData>> => {
    const mutationOptions: UseMutationOptions<NotificationsControllerUpdateSettingsResponse, DefaultError, Options<NotificationsControllerUpdateSettingsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await notificationsControllerUpdateSettings({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const notificationsControllerTestNotificationMutation = (options?: Partial<Options<NotificationsControllerTestNotificationData>>): UseMutationOptions<unknown, DefaultError, Options<NotificationsControllerTestNotificationData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<NotificationsControllerTestNotificationData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await notificationsControllerTestNotification({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const notificationsControllerRequestEmailMutation = (options?: Partial<Options<NotificationsControllerRequestEmailData>>): UseMutationOptions<unknown, DefaultError, Options<NotificationsControllerRequestEmailData>> => {
    const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<NotificationsControllerRequestEmailData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await notificationsControllerRequestEmail({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const notificationsControllerConfirmEmailMutation = (options?: Partial<Options<NotificationsControllerConfirmEmailData>>): UseMutationOptions<NotificationsControllerConfirmEmailResponse, DefaultError, Options<NotificationsControllerConfirmEmailData>> => {
    const mutationOptions: UseMutationOptions<NotificationsControllerConfirmEmailResponse, DefaultError, Options<NotificationsControllerConfirmEmailData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await notificationsControllerConfirmEmail({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const notificationsControllerRemoveDeviceMutation = (options?: Partial<Options<NotificationsControllerRemoveDeviceData>>): UseMutationOptions<NotificationsControllerRemoveDeviceResponse, DefaultError, Options<NotificationsControllerRemoveDeviceData>> => {
    const mutationOptions: UseMutationOptions<NotificationsControllerRemoveDeviceResponse, DefaultError, Options<NotificationsControllerRemoveDeviceData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await notificationsControllerRemoveDevice({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
...
export const notificationsControllerRegisterDeviceMutation = (options?: Partial<Options<NotificationsControllerRegisterDeviceData>>): UseMutationOptions<NotificationsControllerRegisterDeviceResponse, DefaultError, Options<NotificationsControllerRegisterDeviceData>> => {
    const mutationOptions: UseMutationOptions<NotificationsControllerRegisterDeviceResponse, DefaultError, Options<NotificationsControllerRegisterDeviceData>> = {
        mutationFn: async (fnOptions) => {
...
export const discoverControllerPopularOnYourServicesQueryKey = (options?: Options<DiscoverControllerPopularOnYourServicesData>) => createQueryKey('discoverControllerPopularOnYourServices', options);

/**
 * Popular movies and shows on your Streaming Services
 */
export const discoverControllerPopularOnYourServicesOptions = (options?: Options<DiscoverControllerPopularOnYourServicesData>) => queryOptions<DiscoverControllerPopularOnYourServicesResponse, DefaultError, DiscoverControllerPopularOnYourServicesResponse, ReturnType<typeof discoverControllerPopularOnYourServicesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await discoverControllerPopularOnYourServices({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: discoverControllerPopularOnYourServicesQueryKey(options)
});
...
export const streamingServicesControllerListQueryKey = (options?: Options<StreamingServicesControllerListData>) => createQueryKey('streamingServicesControllerList', options);

/**
 * List the Streaming Services available in a watch country, ordered by prominence
 */
export const streamingServicesControllerListOptions = (options?: Options<StreamingServicesControllerListData>) => queryOptions<StreamingServicesControllerListResponse, DefaultError, StreamingServicesControllerListResponse, ReturnType<typeof streamingServicesControllerListQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await streamingServicesControllerList({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: streamingServicesControllerListQueryKey(options)
});
