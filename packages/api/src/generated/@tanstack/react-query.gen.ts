...
export const authControllerLoginWithPdsQueryKey = (options?: Options<AuthControllerLoginWithPdsData>) => createQueryKey('authControllerLoginWithPds', options);

/**
 * Start AT Protocol OAuth sign-in via our PDS
 */
export const authControllerLoginWithPdsOptions = (options?: Options<AuthControllerLoginWithPdsData>) => queryOptions<unknown, DefaultError, unknown, ReturnType<typeof authControllerLoginWithPdsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await authControllerLoginWithPds({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: authControllerLoginWithPdsQueryKey(options)
});
