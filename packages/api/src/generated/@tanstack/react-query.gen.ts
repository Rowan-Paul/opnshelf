...
export const authControllerPermissionsQueryKey = (options: Options<AuthControllerPermissionsData>) => createQueryKey('authControllerPermissions', options);

/**
 * Start an account-wide external integration permission change
 */
export const authControllerPermissionsOptions = (options: Options<AuthControllerPermissionsData>) => queryOptions<unknown, DefaultError, unknown, ReturnType<typeof authControllerPermissionsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: authControllerPermissionsQueryKey(options)
});
