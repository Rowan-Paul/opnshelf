 ...
 */
export const authControllerPermissions = <ThrowOnError extends boolean = false>(options: Options<AuthControllerPermissionsData, ThrowOnError>) => (options.client ?? client).get<unknown, unknown, ThrowOnError>({ url: '/auth/permissions', ...options });
