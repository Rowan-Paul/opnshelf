...
export type PushDeviceWhereInput = {
  ...
  userDid?: Prisma.StringFilter<"PushDevice"> | string
...
export type PushDeviceScalarWhereWithAggregatesInput = {
  ...
  userDid?: Prisma.StringWithAggregatesFilter<"PushDevice"> | string
...
export type PushDeviceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"token" | "userDid" | "platform" | "updatedAt", ExtArgs["result"]["pushDevice"]>
...
export interface PushDeviceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const pushDeviceWithTokenOnly = await prisma.pushDevice.findMany({ select: { token: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many PushDevices and only return the `token`
   * const pushDeviceWithTokenOnly = await prisma.pushDevice.createManyAndReturn({
   *   select: { token: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more PushDevices and only return the `token`
   * const pushDeviceWithTokenOnly = await prisma.pushDevice.updateManyAndReturn({
   *   select: { token: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PushDeviceFieldRefs {
  ...
  readonly userDid: Prisma.FieldRef<"PushDevice", 'String'>
